...
const Earn2 = () => {
  ...
  return (
    <ContentContainer>
        <h2 className='font-pingFangSCRegular font-semibold text-[72px] leading-[100px] text-white mt-40 w-full text-center'>Earn $aZen with DePIN Lite</h2>
        <div className='flex justify-between items-center mt-20 gap-14 h-[260px]'>
            {
                data.map((item)=>(
                    <div key={item.id} className='border border-[#454645] rounded-2xl p-8 flex-1 h-full'>
