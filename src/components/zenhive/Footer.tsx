...
const Footer = () => {
    ...
    return (
        <section className='w-full bg-[#151516] py-16'>
            <div className='flex items-end justify-between pb-14 w-[1280px] mx-auto border-b border-b-[#71717180]'>
                <div>
            ...
            <div className='flex justify-between items-center w-[1280px] mx-auto py-8 mb-8'>
