...
const Earn3 = () => {
  return (
    <ContentContainer>
        <h2 className='font-pingFangSCRegular font-semibold text-[40px] leading-[60px] md:text-[72px] md:leading-[100px] text-white mt-20 md:mt-40 w-full text-center'>Earn $aZen tokens via ZenHive</h2>
